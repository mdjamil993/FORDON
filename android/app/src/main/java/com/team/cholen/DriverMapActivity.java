...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callMe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent callIntent= new Intent(Intent.ACTION_DIAL, Uri.parse("tel: "+callPhn));
        ...
        mLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DriverMapActivity.this, signinActivity.class);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    ...
                    if(map.get("phone")!=null){
                        callPhn = map.get("phone").toString();
    ...
    public void onBackPressed() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder = new AlertDialog.Builder(DriverMapActivity.this, android.R.style.Theme_Material_Dialog_Alert);
        } else {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            ...
            if (!success) {
                Log.e("okkk", "Style parsing failed.");
            }
        } catch (Resources.NotFoundException e) {
            Log.e("okk", "Can't find style. Error: ", e);
        }
        //end of map styling
