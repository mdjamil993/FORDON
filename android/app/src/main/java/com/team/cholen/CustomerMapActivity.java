...
import com.sojib.cholen.historyRecyclerView.PaymentActivity;
...
public class CustomerMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // destinationLatLng = new LatLng(0.0,0.0);
        callme = findViewById(R.id.callMe2);
        callme.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent callIntent= new Intent(Intent.ACTION_DIAL, Uri.parse("tel: "+phn));
        ...
        mLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CustomerMapActivity.this, signinActivity.class);
                ...
                if (requestBol){
                    ...
                    if (destinationLatLng != null)
                    {
                        ...
                        try
                        {
                            ...
                            mRequest.setText("WAAITING FOR YOUR RIDE TO ARIIVE...");
                        ...
                        {
                            Toast.makeText(CustomerMapActivity.this, "Something wrong with getting location", Toast.LENGTH_SHORT).show();
                        }
                    }

                    else
                    {
                        Toast.makeText(CustomerMapActivity.this, "Please Select a place", Toast.LENGTH_SHORT).show();
                    }
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if (dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                                ...
                                if(driverMap.get("service").equals(requestService)){
                                   ...
                                   // Toast.makeText(CustomerMapActivity.this, "Waiting for your Ride to arrive !", Toast.LENGTH_LONG).show();
                                }
                            }
                        }
                        @Override
    ...
    *-------------------------------------------------------------------*/
    ...
    private void endRide(){
        ...
        mRequest.setText("CALL FOR A RIDE");
        ...
        startActivity(new Intent(CustomerMapActivity.this,PaymentActivity.class));
    }
    ...
    *-------------------------------------------------------------------*/
    ...
    private void getDriversAround(){
        ...
        Log.d("geoLoc","lat"+mLastLocation.getLatitude());
        Log.d("geoLoc","lng"+mLastLocation.getLongitude());
    ...
    public void onBackPressed() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            builder = new android.app.AlertDialog.Builder(CustomerMapActivity.this, android.R.style.Theme_Material_Dialog_Alert);
        } else {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                CustomerMapActivity.this.finishAffinity();
            }
        });
